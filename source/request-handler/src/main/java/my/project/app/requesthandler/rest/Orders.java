...
public class Orders {
    ...
    public Response addOrder(final String parameters) {
        ...
        System.out.println("addOrders endpouint input:" + parameters);
        ...
        for (int i=0; i<arr.length(); i++) {
            ...
            try {
                ...
                Order pr = mapper.readValue(o.toString(), Order.class);
                p.add(pr);
    ...
    public Response updateOrders(final String parameters) {
        ...
        String orderNumber = query.getString("orderNumber");

        BasicDBObject searchQuery = new BasicDBObject();
        searchQuery.append("orderNumber", orderNumber);

        query.removeField("orderNumber");
